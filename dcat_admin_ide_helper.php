...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection reverse_direction
     ...
     * @method Grid\Column|Collection reverse_direction(string $label = null)
     ...
     * @property Show\Field|Collection reverse_direction
     ...
     * @method Show\Field|Collection reverse_direction(string $label = null)
