...
(function (undefined) {
	...
	function Schedule(opt) {
		...
		let init = function () {
			...
			let todayBtn = '<div id="todayBtn" class="today">今天</div>';
		...
		let render = function () {
			...
			for (let i = 0; i < total; i++) {
				...
				let nowDate = concatDate(year, month + 1, (i + 1 - startWeek));
				let nowTimestamp = new Date(nowDate).getTime();
				let isDisable = disabledDate.indexOf(nowDate) > -1;
				let isSelected = selectedDate.indexOf(nowDate) > -1;
